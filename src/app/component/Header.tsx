...
const Footer = () => {
    ...
    return (
        <footer className="flex items-center justify-between px-4 md:px-8 py-4 bg-gray-200 text-gray-900 shadow-lg shadow-gray-300">
            {/* Left: Logo */}
            <div>
                <Link href="/">
                    <Image
            ...
            {/* Right: Navigation */}
            <nav className={`absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent z-10 ${menuOpen ? 'block' : 'hidden'} md:flex md:items-center`}>
